...
def format_docs(docs):
    ...
    """
    Aggregates page content from a list of documents, separating each document's
    content with a hyphen and returning the combined text as a single string.

    Args:
        docs (list): collection of code documentation pages to be processed and
            concatenated into a single string.

    Returns:
        str: a list of page contents of the given documentation documents, each
